---
name: mobile-design
description: "[Huevos Point: web POS usado en móvil por empleados, potencial React Native] Mobile-first design thinking and decision-making for iOS and Android apps. Touch interaction, performance patterns, platform conventions. Teaches principles, not fixed values. Use when building React Native, Flutter, or native mobile apps."
allowed-tools: Read, Glob, Grep, Bash
---
## Huevos Point — Contexto del Proyecto

**Estado actual:** Aplicación web (React 19 + MUI v6). NO existe app móvil nativa todavía.

**Uso móvil actual:** Los empleados de cada sucursal usan el sistema desde celulares Android (navegador web). El diseño responsive ya existe pero no está optimizado para touch.

**Stack móvil potencial:** Si se construye app nativa → **React Native + Expo** (equipo ya conoce React).

**Contexto de uso real:**
- Empleados registran ventas parados detrás del mostrador, con una mano
- Pantallas de 5-6" Android, posiblemente con fundas gruesas
- Conexión de datos variable (3G en zonas rurales)
- Uso repetitivo de las mismas acciones (registrar venta, registrar egreso)

**Prioridades de UX móvil para este proyecto:**
1. Botón de "Nueva Venta" accesible con pulgar (thumb zone inferior)
2. Formularios con campos grandes, teclado numérico para cantidades y montos
3. Confirmaciones rápidas (no exceso de pasos para registrar una venta)
4. Funcionalidad offline básica para ventas (sync cuando vuelve conexión)
5. Tablas de movimientos legibles en pantalla pequeña (≤360px)

**Cuando uses esta skill:** Si se decide construir una app React Native, o para mejorar la experiencia responsive web en móviles de empleados.
